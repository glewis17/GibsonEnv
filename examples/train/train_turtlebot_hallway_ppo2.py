...
from gibson.envs.turtlebot_env import TurtlebotMotorServoingEnv
...
def train(num_timesteps, seed):
    ...
    config_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'configs', 'turtlebot_hallway_rgb_train.yaml')
    print(config_file)
    ...
    raw_env = TurtlebotMotorServoingEnv(gpu_count=args.gpu_count,
...
def main():
    train(num_timesteps=100000000, seed=5)
